          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            {data.website && (
              <div>
                ...
                <p className="font-semibold text-sm">{data.website}</p>
              </div>
            )}
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="font-semibold">{data.admin_name}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground flex items-center gap-1">
                  <Mail className="h-3 w-3" />
                ...
                <p className="font-semibold">{data.admin_email}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground flex items-center gap-1">
                  <Phone className="h-3 w-3" />
                ...
                <p className="font-semibold">{data.admin_phone}</p>
              </div>
            </div>
          </div>
        </Card>
      ...
      >
        <Card className="p-6">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Duración Estándar</p>
            ...
            <div>
              ...
              <p className="text-lg font-semibold">{data.currency}</p>
            </div>
          </div>
          <div>
